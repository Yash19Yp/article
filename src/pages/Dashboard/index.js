            ...
            <Column className="absolute bg-black_900 border border-bluegray_900 border-solid font-opensans items-start justify-start left-[0] lg:pb-[517px] xl:pb-[591px] pb-[665px] 3xl:pb-[798px] lg:pt-[18px] xl:pt-[21px] pt-[24px] 3xl:pt-[28px] top-[0] w-[21%]">
              ...
              <Column className="font-gilroy mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] w-[100%]">
                <Row className="items-center justify-start lg:pl-[14px] xl:pl-[16px] pl-[18.5px] 2xl:pl-[18px] 3xl:pl-[22px] 3xl:pr-[100px] lg:pr-[64px] xl:pr-[74px] pr-[83.5px] 2xl:pr-[83px] w-[100%]">
                  <Button className="bg-gray_901 font-medium lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[29%]">{`Ux design`}</Button>
                  <Button className="bg-gray_901 font-medium lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[34%]">{`Ux Research`}</Button>
                </Row>
                <Row className="items-center justify-start lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] lg:pl-[13px] xl:pl-[15px] pl-[17.5px] 2xl:pl-[17px] 3xl:pl-[21px] lg:pr-[46px] xl:pr-[52px] pr-[59.5px] 2xl:pr-[59px] 3xl:pr-[71px] w-[100%]">
                  <Button className="bg-gray_901 font-medium lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[42%]">{`Design Thinking`}</Button>
                  <Button className="bg-gray_901 font-medium lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[30%]">{`Front-end`}</Button>
                </Row>
                <Row className="items-center justify-start lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] lg:pl-[13px] xl:pl-[15px] pl-[17.5px] 2xl:pl-[17px] 3xl:pl-[21px] lg:pr-[47px] xl:pr-[53px] pr-[60.5px] 2xl:pr-[60px] 3xl:pr-[72px] w-[100%]">
                  <Button className="bg-gray_901 font-medium lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[59%]">{`Back-end development`}</Button>
                  <Button className="bg-gray_901 font-medium lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[12%]">{`UI`}</Button>
                </Row>
                <Row className="items-center justify-start lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] lg:px-[13px] xl:px-[15px] px-[17.5px] 2xl:px-[17px] 3xl:px-[21px] w-[100%]">
                  <Button className="bg-gray_901 font-medium lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[22%]">{`Money`}</Button>
                  <Button className="bg-gray_901 font-medium lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[26%]">{`Business`}</Button>
                  <Button className="bg-gray_901 font-medium ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[34%]">{`Productivity`}</Button>
                </Row>
                <Row className="items-center justify-start lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] lg:pl-[13px] xl:pl-[15px] pl-[17.5px] 2xl:pl-[17px] 3xl:pl-[21px] lg:pr-[63px] xl:pr-[72px] pr-[81.5px] 2xl:pr-[81px] 3xl:pr-[97px] w-[100%]">
                  <Button className="bg-gray_901 font-medium lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[32%]">{`Psychology`}</Button>
                  <Button className="bg-gray_901 font-medium lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[32%]">{`Mindfullnes`}</Button>
                </Row>
                <Row className="items-center justify-start lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] lg:pl-[14px] xl:pl-[16px] pl-[18.5px] 2xl:pl-[18px] 3xl:pl-[22px] lg:pr-[105px] xl:pr-[120px] pr-[135.5px] 2xl:pr-[135px] 3xl:pr-[162px] w-[100%]">
                  <Button className="bg-gray_901 font-medium lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[25%]">{`Science`}</Button>
                  <Button className="bg-gray_901 font-medium lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius100 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_50 text-center w-[21%]">{`Books`}</Button>
                </Row>
              </Column>
            </Column>
          </Stack>
