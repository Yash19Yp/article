    ...
    <>
      <Column className="bg-black_900 font-gilroy items-start justify-start mx-[auto] w-[100%]">
        <Column className="items-center w-[100%]">
          ...
          <Column className="border border-bluegray_900 border-solid items-center justify-center lg:mt-[43px] xl:mt-[49px] mt-[56px] 3xl:mt-[67px] lg:px-[177px] xl:px-[202px] px-[228px] 3xl:px-[273px] lg:py-[24px] xl:py-[28px] py-[32px] 3xl:py-[38px] rounded-radius8 w-[47%]">
            <Image
        ...
        <Text className="font-semibold lg:ml-[300px] xl:ml-[343px] ml-[386px] 3xl:ml-[463px] lg:mt-[28px] xl:mt-[32px] mt-[36px] 3xl:mt-[43px] lg:text-[15px] xl:text-[17px] text-[20px] 3xl:text-[24px] text-gray_50 w-[auto]">
          04 Following
        </Text>
        <Column className="items-center lg:mt-[12px] xl:mt-[14px] mt-[16px] 3xl:mt-[19px] w-[100%]">
              ...
              return (
                <Row className="border border-bluegray_900 border-solid items-center justify-start lg:my-[6px] xl:my-[7px] my-[8px] 3xl:my-[9px] pl-[10px] 3xl:pl-[12px] lg:pl-[7px] xl:pl-[8px] lg:pr-[38px] xl:pr-[43px] pr-[49px] 3xl:pr-[58px] py-[10px] 3xl:py-[12px] lg:py-[7px] xl:py-[8px] rounded-radius8 w-[100%]">
                  <Image
                    ...
                    alt="Ellipse2"
                  />
                  <Column className="items-start lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] w-[88%]">
                    <Text className="font-bold lg:text-[15px] xl:text-[17px] text-[20px] 3xl:text-[24px] text-gray_50 w-[auto]">
                      {apiData3Ele?.name}
                    </Text>
                    <Text className="font-normal xl:mt-[3px] lg:mt-[3px] mt-[4px] not-italic lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-gray_50 w-[auto]">
          ...
          <Input
            className="bg-transparent border-0 font-bold p-[0] pl-[10px] 3xl:pl-[12px] lg:pl-[7px] xl:pl-[8px] lg:text-[15px] xl:text-[17px] text-[20px] 3xl:text-[24px] placeholder:text-gray_50 text-gray_50 w-[100%]"
            WrapClassName="2xl:py-[16px] 3xl:mt-[19px] 3xl:pl-[12px] 3xl:py-[19px] border border-bluegray_900 border-solid flex lg:mt-[12px] lg:pl-[7px] lg:py-[12px] mt-[16px] pl-[10px] pr-[0] py-[16.5px] rounded-radius8 w-[47%] xl:mt-[14px] xl:pl-[8px] xl:py-[14px]"
            name="Group48"
            placeholder="Google design"
            prefix={
              <Image
                src={"images/img_ellipse_2_2.svg"}
                className="w-[60px] h-[60px] lg:w-[46px] lg:h-[47px] xl:w-[53px] xl:h-[54px] 2xl:h-[61px] 3xl:w-[72px] 3xl:h-[73px] my-[auto]"
                alt="Ellipse 2"
              />
            }
          ></Input>
