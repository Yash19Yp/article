      ...
      <Column className="bg-black_900 items-start justify-start mx-[auto] w-[100%]">
        <Column className="font-gilroy items-center w-[100%]">
          <header className="w-[100%]">
            <Row className="border border-bluegray_900 border-solid items-center justify-between 3xl:pl-[103px] xl:pl-[76px] pl-[85.87px] 2xl:pl-[85px] 3xl:pr-[102px] xl:pr-[75px] pr-[85px] lg:px-[66px] lg:py-[13px] xl:py-[15px] py-[17px] 3xl:py-[20px] w-[100%]">
              <Image
                ...
                alt="Frame9874"
              />
              <Row className="items-center justify-center lg:mb-[6px] xl:mb-[7px] mb-[8px] 3xl:mb-[9px] lg:ml-[164px] xl:ml-[187px] ml-[210.87px] 2xl:ml-[211px] 3xl:ml-[253px] lg:mt-[5px] xl:mt-[6px] mt-[7px] 3xl:mt-[8px] w-[26%]">
                <Text
                  className="common-pointer font-semibold lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-gray_50 w-[auto]"
              ...
              <Row className="bg-black_900 items-center justify-center mb-[1px] lg:ml-[151px] xl:ml-[173px] ml-[195px] 3xl:ml-[234px] w-[26%]">
                <Button
          ...
          <Image
            ...
            className="lg:h-[389px] xl:h-[445px] h-[500px] 2xl:h-[501px] 3xl:h-[601px] lg:mt-[43px] xl:mt-[49px] mt-[56px] 3xl:mt-[67px] object-contain rounded-radius20 w-[88%]"
            alt="Frame9881"
          />
        </Column>
        <Text className="font-light font-publicsans 3xl:ml-[103px] lg:ml-[66px] xl:ml-[76px] ml-[86px] lg:mt-[43px] xl:mt-[49px] mt-[56px] 3xl:mt-[67px] lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-black_901 w-[auto]">
        ...
        <Text className="font-gilroy font-semibold 3xl:ml-[103px] lg:ml-[66px] xl:ml-[76px] ml-[86px] lg:mt-[23px] xl:mt-[26px] mt-[30px] 3xl:mt-[36px] lg:text-[40px] xl:text-[46px] text-[52px] 3xl:text-[62px] text-gray_50 w-[auto]">
          {apiData6?.title}
        </Text>
        <Column className="items-center lg:mt-[43px] xl:mt-[49px] mt-[56px] 3xl:mt-[67px] lg:pl-[178px] xl:pl-[204px] pl-[230px] 3xl:pl-[276px] lg:pr-[170px] xl:pr-[194px] pr-[219px] 3xl:pr-[262px] w-[100%]">
          <Row className="font-publicsans items-start justify-start w-[99%]">
            <Image
            ...
            <Column className="font-gilroy items-start justify-start lg:mb-[5px] xl:mb-[6px] mb-[7px] 3xl:mb-[8px] lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] mt-[11px] 3xl:mt-[13px] lg:mt-[8px] xl:mt-[9px] w-[18%]">
              <Text className="font-semibold lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-bluegray_50 w-[auto]">
                {apiData6?.user?.name}
              </Text>
              <Text className="font-normal lg:mt-[5px] xl:mt-[6px] mt-[7px] 3xl:mt-[8px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_100 w-[auto]">
                {apiData6?.readable_publish_date}
              </Text>
            </Column>
            <Input
              className="bg-transparent border-0 font-medium p-[0] pl-[10px] 3xl:pl-[12px] lg:pl-[7px] xl:pl-[8px] lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] placeholder:text-bluegray_50 text-bluegray_50 w-[100%]"
              WrapClassName="2xl:pl-[31px] 2xl:pr-[29px] 2xl:py-[21px] 3xl:ml-[638px] 3xl:pl-[37px] 3xl:pr-[35px] 3xl:py-[25px] border border-bluegray_50 border-solid flex lg:ml-[413px] lg:my-[3px] lg:pl-[24px] lg:pr-[23px] lg:py-[16px] ml-[532px] my-[4px] pl-[31.5px] pr-[29.94px] py-[21.3px] rounded-radius5 w-[19%] xl:ml-[473px] xl:my-[3px] xl:pl-[28px] xl:pr-[26px] xl:py-[18px]"
              name="Group46"
              placeholder="Share Now"
              prefix={
                <Image
                  src={"images/img_vector.svg"}
                  className="w-[25px] lg:w-[19px] xl:w-[22px] 3xl:w-[30px] my-[auto]"
                  alt="Vector"
                />
              }
            ></Input>
          </Row>
          <Text className="font-gilroy font-medium lg:leading-[27px] xl:leading-[31px] leading-[35.00px] 2xl:leading-[35px] 3xl:leading-[42px] lg:mt-[43px] xl:mt-[49px] mt-[56px] 3xl:mt-[67px] lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_100 text-left w-[99%]">
            {apiData6?.description}
          </Text>
          <Text className="font-light font-publicsans lg:leading-[27px] xl:leading-[31px] leading-[35.00px] 2xl:leading-[35px] 3xl:leading-[42px] lg:mt-[21px] xl:mt-[24px] mt-[28px] 3xl:mt-[33px] lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_100 text-left w-[99%]">
          ...
          <Text className="font-gilroy font-medium lg:leading-[27px] xl:leading-[31px] leading-[35.00px] 2xl:leading-[35px] 3xl:leading-[42px] lg:mt-[21px] xl:mt-[24px] mt-[28px] 3xl:mt-[33px] lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_100 text-left w-[99%]">
          ...
          <Row className="lg:gap-[22px] xl:gap-[25px] gap-[29px] 3xl:gap-[34px] grid grid-cols-2 items-center justify-center lg:mt-[38px] xl:mt-[44px] mt-[50px] 3xl:mt-[60px] px-[0] w-[99%]">
            <Image
          ...
          <Text className="font-gilroy font-medium lg:leading-[27px] xl:leading-[31px] leading-[35.00px] 2xl:leading-[35px] 3xl:leading-[42px] lg:mt-[38px] xl:mt-[44px] mt-[50px] 3xl:mt-[60px] lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_100 text-left w-[99%]">
        ...
        <Row className="font-gilroy items-center justify-start lg:ml-[211px] xl:ml-[241px] ml-[272px] 3xl:ml-[326px] lg:mt-[15px] xl:mt-[17px] mt-[20px] 3xl:mt-[24px] w-[34%]">
          ...
          <Text className="font-medium lg:ml-[11px] xl:ml-[13px] ml-[15px] 3xl:ml-[18px] lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_100 w-[auto]">
        ...
        <Column className="font-gilroy items-center lg:mt-[21px] xl:mt-[24px] mt-[28px] 3xl:mt-[33px] lg:pl-[188px] xl:pl-[215px] pl-[242px] 3xl:pl-[290px] lg:pr-[170px] xl:pr-[194px] pr-[219px] 3xl:pr-[262px] w-[100%]">
          <Text className="font-medium lg:leading-[27px] xl:leading-[31px] leading-[35.00px] 2xl:leading-[35px] 3xl:leading-[42px] lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_100 text-left w-[100%]">
            Could someone survive inside a transporter buffer for 75 years?
            Fate. It protects fools, little children, and ships named
            “Enterprise.”
          </Text>
        </Column>
        <Text className="font-gilroy font-medium lg:ml-[188px] xl:ml-[215px] ml-[242px] 3xl:ml-[290px] lg:mt-[31px] xl:mt-[35px] mt-[40px] 3xl:mt-[48px] lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-bluegray_50 w-[auto]">
          Tags
        </Text>
        <Row className="font-gilroy items-center justify-start lg:ml-[188px] xl:ml-[215px] ml-[242px] 3xl:ml-[290px] lg:mt-[11px] xl:mt-[13px] mt-[15px] 3xl:mt-[18px] w-[35%]">
          <Button className="bg-gray_901 font-medium py-[10.54px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[8px] xl:py-[9px] rounded-radius50 lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_50 text-center w-[19%]">
            Writing
          </Button>
          <Button className="bg-gray_901 font-medium lg:ml-[13px] xl:ml-[15px] ml-[17px] 3xl:ml-[20px] py-[10.54px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[8px] xl:py-[9px] rounded-radius50 lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_50 text-center w-[19%]">
            Tutorial
          </Button>
          <Button className="bg-gray_901 font-medium lg:ml-[13px] xl:ml-[15px] ml-[17px] 3xl:ml-[20px] py-[10.54px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[8px] xl:py-[9px] rounded-radius50 lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_50 text-center w-[19%]">
            How to
          </Button>
          <Button className="bg-gray_901 font-medium lg:ml-[11px] xl:ml-[13px] ml-[15px] 3xl:ml-[18px] py-[10.54px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[8px] xl:py-[9px] rounded-radius50 lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_50 text-center w-[15%]">
            Book
          </Button>
          <Button className="bg-gray_901 font-medium lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] py-[10.54px] 2xl:py-[10px] 3xl:py-[12px] lg:py-[8px] xl:py-[9px] rounded-radius50 lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_50 text-center w-[15%]">
            2020
          </Button>
        </Row>
        ...
        <Text className="font-gilroy font-semibold lg:ml-[141px] xl:ml-[161px] ml-[182px] 3xl:ml-[218px] mt-[112px] 3xl:mt-[134px] lg:mt-[87px] xl:mt-[99px] lg:text-[21px] xl:text-[24px] text-[28px] 3xl:text-[33px] text-gray_50 w-[auto]">
          More Like these
        </Text>
        <Column className="font-gilroy items-center lg:mt-[23px] xl:mt-[26px] mt-[30px] 3xl:mt-[36px] w-[100%]">
          <List
            className="lg:gap-[18px] xl:gap-[21px] gap-[24px] 3xl:gap-[28px] grid grid-cols-3 min-h-[auto] w-[75%]"
