...
const WriteonmediumPage = () => {
  ...
  const form = useForm(
    { title: "", content: "", canonicalUrl: "", tags: "" },
    {
      validate: true,
  ...
  function callApi(data) {
    const req = {
      data: {
        ...data,
        contentFormat: "html",
        publishStatus: Content_format.publishStatus,
      },
    };
    postPosts(req)
      .then((res) => {
    ...
    <>
      <Column className="bg-black_900 font-gilroy items-center justify-start mx-[auto] lg:pb-[38px] xl:pb-[44px] pb-[50px] 3xl:pb-[60px] w-[100%]">
        ...
        <Row className="items-start justify-start lg:mt-[24px] xl:mt-[28px] mt-[32px] 3xl:mt-[38px] lg:px-[24px] xl:px-[28px] px-[32px] 3xl:px-[38px] w-[100%]">
          ...
          <Column className="items-start justify-start lg:mb-[297px] xl:mb-[340px] mb-[383px] 3xl:mb-[459px] lg:ml-[18px] xl:ml-[21px] ml-[24px] 3xl:ml-[28px] w-[32%]">
